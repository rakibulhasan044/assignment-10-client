...
const CraftSection = ({ crafts }) => {
  ...
  return (
    <div className="py-8 md:py-10 lg:py-16">
      ...
      <div className="grid grid-cols-3 lg:grid-cols-6 py-2 font-semibold gap-3 text-xl dark:text-orange-600">
        <Link className="hover:bg-orange-300 dark:hover:bg-[#893271] cursor-pointer text-center py-2 rounded-3xl">
          Landscape Painting
        </Link>
        <div className="hover:bg-orange-300 dark:hover:bg-[#893271] cursor-pointer text-center py-2 rounded-3xl">
          Portrait Drawing
        </div>
        <div className="hover:bg-orange-300 dark:hover:bg-[#893271] cursor-pointer text-center py-2 rounded-3xl">
